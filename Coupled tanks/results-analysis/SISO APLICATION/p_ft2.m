function [fig1,fig2,fig3,fig4] = p_ft2(ts,h,ref,u,tempo,Kp,Kd,Ki,Am)
        ...
        trail = ['./figures'];
        if (~exist(trail)) mkdir(trail);end   
        saveas(fig1,['./figures/','FT2I-PID-FG_Resposta_Tanque','.png'])
        ...
        saveas(fig2,['./figures/','FT2I-PID-FG_Sinal_de_Controle','.png'])
        ...
        legend('Kc','Kd','Ki')
        saveas(fig3,['./figures/','FT2I-PID-FG_Kp,Ki,Kd','.png'])

        fig4 = figure;
        grid;
        plot(tempo,Am,'g-');
        title('FT2I-PID-FG: Am')
        saveas(fig4,['./figures/','FT2I-PID-FG_Am','.png'])
